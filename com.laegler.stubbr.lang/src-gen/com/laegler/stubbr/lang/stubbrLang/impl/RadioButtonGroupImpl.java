 ...
 * </p>
 * <ul>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.RadioButtonGroupImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.RadioButtonGroupImpl#getJavaType <em>Java Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RadioButtonGroupImpl extends ElementImpl implements RadioButtonGroup
{
  /**
  ...
  {
    return StubbrLangPackage.eINSTANCE.getRadioButtonGroup();
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.RADIO_BUTTON_GROUP__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Entity newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.RADIO_BUTTON_GROUP__TYPE, oldType, type));
  }
  ...
  public JvmType getJavaType()
  {
    if (javaType != null && javaType.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.RADIO_BUTTON_GROUP__JAVA_TYPE, oldJavaType, javaType));
      }
    }
    return javaType;
  }
  ...
  public void setJavaType(JvmType newJavaType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.RADIO_BUTTON_GROUP__JAVA_TYPE, oldJavaType, javaType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StubbrLangPackage.RADIO_BUTTON_GROUP__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case StubbrLangPackage.RADIO_BUTTON_GROUP__JAVA_TYPE:
