 ...
 * </p>
 * <ul>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.ThenStepImpl#getAction <em>Action</em>}</li>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.ThenStepImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.ThenStepImpl#getSubjectElement <em>Subject Element</em>}</li>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.ThenStepImpl#getSubjectWildcard <em>Subject Wildcard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThenStepImpl extends StepImpl implements ThenStep
{
  ...
  {
    return StubbrLangPackage.eINSTANCE.getThenStep();
  }
  ...
  public void setAction(BehaviorAction newAction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.THEN_STEP__ACTION, oldAction, action));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.THEN_STEP__VALUE, oldValue, value));
  }
  ...
  public UiElement getSubjectElement()
  {
    if (subjectElement != null && subjectElement.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.THEN_STEP__SUBJECT_ELEMENT, oldSubjectElement, subjectElement));
      }
    }
  ...
  public void setSubjectElement(UiElement newSubjectElement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.THEN_STEP__SUBJECT_ELEMENT, oldSubjectElement, subjectElement));
  }
  ...
  public void setSubjectWildcard(String newSubjectWildcard)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.THEN_STEP__SUBJECT_WILDCARD, oldSubjectWildcard, subjectWildcard));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StubbrLangPackage.THEN_STEP__ACTION:
        return getAction();
      case StubbrLangPackage.THEN_STEP__VALUE:
        return getValue();
      case StubbrLangPackage.THEN_STEP__SUBJECT_ELEMENT:
        if (resolve) return getSubjectElement();
        return basicGetSubjectElement();
      case StubbrLangPackage.THEN_STEP__SUBJECT_WILDCARD:
