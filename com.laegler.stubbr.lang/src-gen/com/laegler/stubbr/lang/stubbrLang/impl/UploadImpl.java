 ...
 * </p>
 * <ul>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.UploadImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.UploadImpl#getJavaType <em>Java Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UploadImpl extends ElementImpl implements Upload
{
  /**
  ...
  {
    return StubbrLangPackage.eINSTANCE.getUpload();
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.UPLOAD__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Entity newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.UPLOAD__TYPE, oldType, type));
  }
  ...
  public JvmType getJavaType()
  {
    if (javaType != null && javaType.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.UPLOAD__JAVA_TYPE, oldJavaType, javaType));
      }
    }
    return javaType;
  }
  ...
  public void setJavaType(JvmType newJavaType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.UPLOAD__JAVA_TYPE, oldJavaType, javaType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StubbrLangPackage.UPLOAD__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case StubbrLangPackage.UPLOAD__JAVA_TYPE:
