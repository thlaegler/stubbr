 ...
 * </p>
 * <ul>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.InputFieldImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.laegler.stubbr.lang.stubbrLang.impl.InputFieldImpl#getJavaType <em>Java Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputFieldImpl extends ElementImpl implements InputField
{
  /**
  ...
  {
    return StubbrLangPackage.eINSTANCE.getInputField();
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.INPUT_FIELD__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Entity newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.INPUT_FIELD__TYPE, oldType, type));
  }
  ...
  public JvmType getJavaType()
  {
    if (javaType != null && javaType.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, StubbrLangPackage.INPUT_FIELD__JAVA_TYPE, oldJavaType, javaType));
      }
    }
    return javaType;
  }
  ...
  public void setJavaType(JvmType newJavaType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StubbrLangPackage.INPUT_FIELD__JAVA_TYPE, oldJavaType, javaType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StubbrLangPackage.INPUT_FIELD__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case StubbrLangPackage.INPUT_FIELD__JAVA_TYPE:
