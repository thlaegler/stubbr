...
public class HandlerType {
    ...
    protected com.laegler.stubbr.lang.ext.model.webapp.v3_1.String handlerName;
    ...
    protected List<com.laegler.stubbr.lang.ext.model.webapp.v3_1.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.laegler.stubbr.lang.ext.model.webapp.v3_1.String> portName;
     ...
     *     
     */
    public com.laegler.stubbr.lang.ext.model.webapp.v3_1.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.laegler.stubbr.lang.ext.model.webapp.v3_1.String value) {
     ...
     * 
     */
    public List<com.laegler.stubbr.lang.ext.model.webapp.v3_1.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.laegler.stubbr.lang.ext.model.webapp.v3_1.String>();
        }
     ...
     * 
     */
    public List<com.laegler.stubbr.lang.ext.model.webapp.v3_1.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.laegler.stubbr.lang.ext.model.webapp.v3_1.String>();
        }
