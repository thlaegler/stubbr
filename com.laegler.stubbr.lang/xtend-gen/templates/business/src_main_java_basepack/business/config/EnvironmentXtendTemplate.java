...
public class EnvironmentXtendTemplate extends AbstractXtendTemplate {
  public EnvironmentXtendTemplate(final StubbrRegistry stubbr, final Project project) {
    super(stubbr, project);
    this.setFileName("Environment");
    ...
    this.setDocumentation("Environment configuration");
  ...
  private String getTemplate() {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("DEFAULT, LOCAL, TEST, STAGE, PROD");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
