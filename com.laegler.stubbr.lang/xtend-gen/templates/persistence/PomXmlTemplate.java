...
public class PomXmlTemplate extends PomXmlTemplateBase {
  ...
  private String getTemplate() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<!-- Internal dependencies -->");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<!-- Project-specific dependencies -->");
    _builder.newLine();
    {
      ...
      if (_isUseSpringMVC) {
        ...
        _builder.append("\t");
        _builder.append("    ");
        _builder.append("<groupId>org.springframework.data</groupId>");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("    ");
        _builder.append("<artifactId>spring-data-jpa</artifactId>");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("    ");
        _builder.append("<version>1.10.5.RELEASE</version>");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("</dependency>");
        _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<!-- Other dependencies -->");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<dependency>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<version>6.0.3</version>");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("</dependency>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<groupId>org.hibernate.javax.persistence</groupId>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<artifactId>hibernate-jpa-2.1-api</artifactId>");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<artifactId>hibernate-core</artifactId>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<version>5.2.2.Final</version>");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("</dependency>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<artifactId>hibernate-validator</artifactId>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<version>5.2.2.Final</version>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<groupId>org.hibernate.common</groupId>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<artifactId>hibernate-commons-annotations</artifactId>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<version>5.0.1.Final</version>");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("</dependency>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t   \t");
    _builder.append("<ejbVersion>3.1</ejbVersion>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</configuration>");
    _builder.newLine();
