...
public class EntityXtendTemplate extends AbstractXtendTemplate {
  private Entity entity;
  
  public EntityXtendTemplate(final StubbrRegistry stubbr, final Project project, final Entity entity) {
    ...
    _builder_3.append("Entity model for ");
    String _name_1 = null;
    if (entity!=null) {
