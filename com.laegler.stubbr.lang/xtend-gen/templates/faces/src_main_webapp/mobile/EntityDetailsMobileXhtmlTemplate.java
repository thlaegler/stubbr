...
/**
 * File template for JSF/XHTML mobile details page for entity.
 */
@SuppressWarnings("all")
public class EntityDetailsMobileXhtmlTemplate extends AbstractMobileXhtmlTemplate {
  @Accessors
  private Entity entity;
  
  public EntityDetailsMobileXhtmlTemplate(final StubbrRegistry stubbr, final Project project, final Entity entity) {
    ...
    _builder_2.append("JSF/XHTML mobile details page for entity ");
    String _name_2 = null;
    if (entity!=null) {
  ...
  public String getTemplate() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<f:viewParam name=\"#{http.post.param.");
    String _name = null;
    if (this.entity!=null) {
    ...
    _builder.newLine();
    {
      ...
      for(final Attribute attribute : _attributes) {
        ...
        if (_name_15!=null) {
          _firstLower_15=StringExtensions.toFirstLower(_name_15);
        }
        ...
        if (_name_16!=null) {
          _firstLower_16=StringExtensions.toFirstLower(_name_16);
        }
        ...
        String _lowerCase = null;
        if (_name_17!=null) {
          _lowerCase=_name_17.toLowerCase();
        }
        _builder.append(_lowerCase, "\t\t\t\t\t\t");
        _builder.append(".");
        String _name_18 = null;
        if (attribute!=null) {
          _name_18=attribute.getName();
        }
    ...
    if (_name_26!=null) {
      _firstLower_25=StringExtensions.toFirstLower(_name_26);
    }
    ...
    if (_name_27!=null) {
      _firstLower_26=StringExtensions.toFirstLower(_name_27);
    }
    ...
    String _lowerCase_1 = null;
    if (_name_28!=null) {
      _lowerCase_1=_name_28.toLowerCase();
    }
    ...
    if (_name_30!=null) {
      _firstLower_28=StringExtensions.toFirstLower(_name_30);
    }
    ...
    if (_name_31!=null) {
      _firstLower_29=StringExtensions.toFirstLower(_name_31);
    }
    ...
    if (_name_32!=null) {
      _lowerCase_2=_name_32.toLowerCase();
    }
    ...
    if (_name_33!=null) {
      _lowerCase_3=_name_33.toLowerCase();
    }
