...
public class DotProjectTemplate extends EclipseDotProjectTemplateBase {
  public DotProjectTemplate(final StubbrRegistry stubbr, final Project project) {
    super(stubbr, project);
    this.setDocumentation("Eclipse project file for EAR project");
