...
public class StubbrLangServlet /* implements XtextServlet  */{
  ...
  public Object init() {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\n=> cannot be resolved."
      + "\n+= cannot be resolved."
      + "\nThe method createInjectorAndDoEMFRegistration() is undefined for the type StubbrLangWebSetup"
      + "\nInvalid number of arguments. The constructor StubbrLangWebSetup() is not applicable for the arguments (Provider)"
